...
! function (a, b, c) {
    ...
    a.RichTextCodeMirrorAdapter = function () {
        ...
        return b.prototype.detach = function () {
            ...
            if ("undefined" != typeof document && null !== document) {
                ...
                if (!this.addedStyleRules[a]) return this.addedStyleRules[a] = !0,
                    this.addedStyleSheet.insertRule(a, 0)
            }
    ...
    return a.Firepad = function (b) {
        ...
        return o.makeEventEmitter(c), c.fromCodeMirror = c, c.fromACE = c, c.prototype.dispose = function () {
            ...
            a.setAttribute("href", "https://navaneethnavi.github.io/PenDown/"), a.setAttribute("target", "_blank"), this.firepadWrapper_.appendChild(a)
